export default {
  ...
  settings: {
    ...
    systemPrompt: {
      ...
      tips: {
        title: '💡 उपयोग टिप्स',
        guidance: 'स्पष्ट मार्गदर्शन: AI को बताएं कि सर्च इंटेंट को कैसे समझना है और Everything सिंटैक्स में कैसे बदलना है',
        examples: 'उदाहरण शामिल करें: प्रॉम्प्ट में कुछ रूपांतरण उदाहरण शामिल करने से सटीकता बेहतर होगी',
        concise: 'संक्षिप्त रखें: अत्यधिक जटिल निर्देशों से बचें, प्रॉम्प्ट को स्पष्ट और समझने योग्य रखें',
        test: 'प्रभावशीलता का परीक्षण करें: संशोधन के बाद वास्तविक सर्च के माध्यम से प्रभावशीलता की जांच कर सकते हैं'
      }
    },
