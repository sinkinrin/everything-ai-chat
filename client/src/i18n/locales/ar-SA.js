  ...
  settings: {
    ...
    systemPrompt: {
      ...
      tips: {
        ...
        guidance: 'إرشاد واضح: أخبر الذكاء الاصطناعي كيفية فهم نية البحث والتحويل إلى صيغة Everything',
        examples: 'تضمين أمثلة: تضمين بعض أمثلة التحويل في التلقين سيحسن الدقة',
        concise: 'اجعلها مختصرة: تجنب التعليمات المعقدة جداً، اجعل التلقين واضحاً ومفهوماً',
        test: 'اختبار الفعالية: بعد التعديل، يمكنك التحقق من الفعالية من خلال البحث الفعلي'
      }
    },
